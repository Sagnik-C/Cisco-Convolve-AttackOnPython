...
function AppContent({ product, model, setProduct, setModel }) {
...
export default function App({ product, model, setProduct, setModel }) {
    return <AppContent product={product} setProduct={setProduct} model={model} setModel={setModel} />;
}
